...
public: 
  ...
  inline void s(T a,unsigned int n0);
  inline void add(T a,unsigned int n0);
  inline void mul(T a,unsigned int n0);
...
template <typename T>
inline void Vector<T>::s(T a, unsigned int n0) {
    if(n0 <= n-1 )
        v[n0] = a;
}
template <typename T>
inline void Vector<T>::add(T a, unsigned int n0) {
    if(n0 <= n-1 )
        v[n0] += a;
}
template <typename T>
inline void Vector<T>::mul(T a, unsigned int n0) {
    if(n0 <= n-1 )
        v[n0] *= a;
}
...
public:
  ...
  inline void s(T a,unsigned int n0,unsigned int m0);
  inline void add(T a,unsigned int n0,unsigned int m0);
  inline void mul(T a,unsigned int n0,unsigned int m0);
...
template <typename T>
inline void Matrix<T>::s(T a, unsigned int n0,unsigned int m0) {
    if(n0 <= n-1 && m0 <= m-1) {
        v[n0][m0] = a;
    }
...
template <typename T>
inline void Matrix<T>::add(T a, unsigned int n0, unsigned int m0) {
    if(n0 <= n-1 && m0 <= m-1)
        v[n0][m0]+= a;
}

template <typename T>
inline void Matrix<T>::mul(T a, unsigned int n0, unsigned int m0) {
    if(n0 <= n-1 && m0 <= m-1)
        v[n0][m0] *= a;
}
