...
private:
    ...
    double t_xx[5000], t_dx[5000], t_d2x[5000], t_yy[5000], t_dy[5000], t_d2y[5000];    //temporal variables for reducing the time complexity

    alglib::spline1dinterpolant last_spl_x, last_spl_y;
    int last_update_time; // last update time on which the A* planner is called
};
