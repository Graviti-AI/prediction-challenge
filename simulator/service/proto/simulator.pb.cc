...
static bool descriptor_table_simulator_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_simulator_2eproto = {
  &descriptor_table_simulator_2eproto_initialized, descriptor_table_protodef_simulator_2eproto, "simulator.proto", 679,
...
static bool dynamic_init_dummy_simulator_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_simulator_2eproto), true);
namespace service {
...
State::State(const State& from)
  ...
  if (!from._internal_agent_type().empty()) {
    agent_type_.AssignWithDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from.agent_type_);
  }
...
// @@protoc_insertion_point(message_clear_start:service.State)
  ...
  agent_type_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  ::memset(&track_id_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&width_) -
      reinterpret_cast<char*>(&track_id_)) + sizeof(width_));
...
void State::InternalSwap(State* other) {
  ...
  agent_type_.Swap(&other->agent_type_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          resp_code_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // string msg = 2;
...
template<> PROTOBUF_NOINLINE ::service::PushMyTrajectoryRequest* Arena::CreateMaybeMessage< ::service::PushMyTrajectoryRequest >(Arena* arena) {
  return Arena::CreateInternal< ::service::PushMyTrajectoryRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::service::PushMyTrajectoryResponse* Arena::CreateMaybeMessage< ::service::PushMyTrajectoryResponse >(Arena* arena) {
  return Arena::CreateInternal< ::service::PushMyTrajectoryResponse >(arena);
}
