    ...
    WithStreamedUnaryMethod_FetchEnv() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler<
          ::service::FetchEnvRequest, ::service::FetchEnvResponse>(
            [this](::grpc_impl::ServerContext* context,
                   ::grpc_impl::ServerUnaryStreamer<
                     ::service::FetchEnvRequest, ::service::FetchEnvResponse>* streamer) {
                       return this->StreamedFetchEnv(context,
                         streamer);
                  }));
    }
   ...
   public:
    WithStreamedUnaryMethod_PushMyTrajectory() {
      ::grpc::Service::MarkMethodStreamed(1,
        new ::grpc::internal::StreamedUnaryHandler<
          ::service::PushMyTrajectoryRequest, ::service::PushMyTrajectoryResponse>(
            [this](::grpc_impl::ServerContext* context,
                   ::grpc_impl::ServerUnaryStreamer<
                     ::service::PushMyTrajectoryRequest, ::service::PushMyTrajectoryResponse>* streamer) {
                       return this->StreamedPushMyTrajectory(context,
                         streamer);
                  }));
    }
