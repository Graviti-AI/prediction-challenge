...
inline void State::_internal_set_agent_type(const std::string& value) {
  ...
  agent_type_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
...
inline void State::set_agent_type(const char* value) {
  ...
  agent_type_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void State::set_agent_type(const char* value, size_t size) {
  ...
  agent_type_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline std::string* State::_internal_mutable_agent_type() {
  ...
  return agent_type_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* State::release_agent_type() {
  // @@protoc_insertion_point(field_release:service.State.agent_type)
  
  return agent_type_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void State::set_allocated_agent_type(std::string* agent_type) {
  ...
  agent_type_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), agent_type);
...
inline ::service::Trajectory* FetchEnvResponse::_internal_mutable_trajectory() {
  ...
  if (trajectory_ == nullptr) {
    auto* p = CreateMaybeMessage<::service::Trajectory>(GetArenaNoVirtual());
    trajectory_ = p;
  }
  return trajectory_;
}
