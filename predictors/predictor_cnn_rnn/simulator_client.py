...
import predictors.traj
import simulator_pb2
import simulator_pb2_grpc


class SimulatorClient:
    def __init__(self, logger: logging.Logger, server_address, user_predictor: predictors.predictor.Predictor):
        self._logger = logger
    ...
    def _proto_traj_to_traj(proto_traj):
        trajectory = predictors.traj.Trajectory()
        for pt in proto_traj.state:
            trajectory.append_state(predictors.traj.State(pt))
        return trajectory
