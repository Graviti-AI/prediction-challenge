...
`other_trajs`: List of `Trajectory`’s that represents the history of the nearby vehicles (may not be used by planner). Note: this represents the history (ie. the trajectory of the vehicle so far), NOT the planned trajectory!
